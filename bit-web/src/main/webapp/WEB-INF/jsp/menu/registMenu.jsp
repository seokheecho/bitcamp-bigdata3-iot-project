...
<title>Menu Mgt Admin</title>
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/resources/assets/css/chosen.min.css" />
        ...
        <ul class="nav ace-nav">
          ...
          <li class="light-blue dropdown-modal">
            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                <img class="nav-user-photo" src="images/avatars/master.png" alt="Jason's Photo" />
              ...
              <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="update.do" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="template"> 메뉴 템플릿 </label>

                    <div class="col-sm-5">
                      <select id="template" name="template" class="col-xs-12" style="height: 34px">
                        <option value="templateType"> - 템플릿을 선택하세요 - </option>
                        <option value="templateType1">${template.templateType}</option>
                        <option value="templateType2">${template.templateType}</option>
                      </select>
                    </div>
                    
                    <!-- 클릭시 모달창 -->
                    <div class="col-sm-2">
                      <a href="#my-modal" type="button" class="btn btn-success" role="button" data-toggle="modal">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="templateTitle"> 템플릿 이름 </label>

                    <div class="col-sm-5">
                      <input type="text" name="templateTitle" id="templateTitle" value="${template.templateTitle}" placeholder="템플릿이름" class="col-xs-12" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="template"> 메뉴 영역 설정 </label>
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="form-field-2"> 민국 요청 부분 </label>

                    <div class="col-sm-5">
                      <input type="text" name="" id="form-field-2" value="" placeholder="메뉴타입?? 셀렉트옵션타입?" class="col-xs-12" />
                    </div>
                  </div>
                  ...
                  <a href="#modal-form" role="button" class="blue" data-toggle="modal"> 상세 메뉴 등록 </a>
                  </h4>
                  </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                       <div class="image fit">
                         <img class="img-thumbnail" id="output" alt="menuboard image" items="${branch.photoList}" var="path" src=""/> 
                        </div>
                    </div>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <img class="image fit" id="output-temp" alt="menu template image" src="images/menuwindow01.png" />
                      </div>
                      ...
                      <div class="modal-body">
                        <div class="row">
                          <div class="col-xs-12 white">
                            ...
                            <br />
                            <p align="center">현재 보고 계시는 템플릿은 <span id="template">${template.templateType}</span> 입니다.</p>
                          </div>
                        </div>
                      </div>
                    </div><!-- /.modal-content -->
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                              <label for="form-field-select-3" for="menuTitle"> 메뉴명</label>
                              <!-- 메뉴이름 select option 형식임? -->
                              <div>
                                <select class="chosen-select" name="menu_title" id="menuTitle" data-placeholder="메뉴명 선택">
                                  <option value=""> - 메뉴 이름 선택 - </option>
                                  <option value="">홍콩반점 띵호와~ㅋ</option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div>
                                <input type="text" name="menu_price" id="menuPrice" value="" placeholder="메뉴 가격" />
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <label for="menuCal"> 열량</label>

                              <div>
                                <input type="text" name="menu_cal" id="menuCal" value="" placeholder="열량 입력" />
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <label for="form-field-first"> 메뉴분류?</label>

                              <div>
                                <select class="chosen-select" id="menuDivision" name="menu_division" data-placeholder="메뉴분류">
...
<![endif]-->
    ...
    <![endif]-->
    <script src="${pageContext.servletContext.contextPath}/resources/assets/js/jquery-ui.custom.min.js"></script>
    
    <script src="${pageContext.servletContext.contextPath}/resources/assets/js/chosen.jquery.min.js"></script>
    <script src="${pageContext.servletContext.contextPath}/resources/assets/js/jquery.knob.min.js"></script>
    <script src="${pageContext.servletContext.contextPath}/resources/assets/js/autosize.min.js"></script>
    <script src="${pageContext.servletContext.contextPath}/resources/assets/js/jquery.inputlimiter.min.js"></script>
    <script src="${pageContext.servletContext.contextPath}/resources/assets/js/jquery.maskedinput.min.js"></script>
