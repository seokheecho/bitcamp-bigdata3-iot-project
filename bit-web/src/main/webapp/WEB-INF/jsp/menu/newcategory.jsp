						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" action="insert"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class=" col-xs-10 col-sm-6" id="category" name="category" data-placeholder="메뉴분류">
											<option name="category" value=""> - 메뉴분류 선택 - </option>
											<option name="category" value="Steak">Steak</option>
											...
											<option name="category" value="Drink">Drink</option>
										</select>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-icon-1"> 분류 정보 </label>

									<div class="col-sm-9">
										<span class="input-icon"> <input type="text"
											name="categoryContent" id="form-field-icon-1" /> <i
