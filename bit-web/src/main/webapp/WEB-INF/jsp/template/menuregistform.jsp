						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" action="regist"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class=" col-xs-10 col-sm-6" id="menuType" name="menuType" data-placeholder="메뉴분류">
											<option name="menuType" value=""> - 메뉴분류 선택 - </option>
											<option name="menuType" value="Beef">Beef</option>
											<option name="menuType" value="Pork">Pork</option>
											<option name="menuType" value="Chicken">Chicken</option>
											<option name="menuType" value="Fish">Fish</option>
											<option name="menuType" value="Vegetarian">Vegetarian</option>
											<option name="menuType" value="Sandwich">Sandwich</option>
											<option name="menuType" value="Salad">Salad</option>
											<option name="menuType" value="Soup">Soup</option>
											<option name="menuType" value="Noodle">Noodle</option>
											<option name="menuType" value="Rice">Rice</option>
											<option name="menuType" value="Dessert">Dessert</option>
											<option name="menuType" value="Drink">Drink</option>
										</select>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1-4"> 열량 </label>

									<div class="col-sm-9">
										<input type="text" name="menuKcal" id="form-field-1-4"
											class="col-xs-10 col-sm-6" />
									</div>
								</div>
								...
								<div class="row">
									...
									<%-- <div class="col-xs-12 col-sm-6">
										...
										<div class="image fit">
											<c:forEach items='${menu.menuImage}' var='path'>
