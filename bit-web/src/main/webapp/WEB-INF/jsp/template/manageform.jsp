			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							템플릿 정보 <small> <i
								class="ace-icon fa fa-angle-double-right"></i> 각 등록 템플릿 정보
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
												...
												<%-- <c:choose>
													<c:when test="${item.deleteCheck eq 'N'}"> --%>
														<tr>
															...
															<td class="hidden-480">${item.tempManagerNo}</td>
															<td class="hidden-480">${item.templateType}</td>
															...
															<td>
																<div class="hidden-sm hidden-xs btn-group">
																	...
																	<button class="btn btn-xs btn-info"
																		onclick="doEdit(${item.tpno})">
																		<i class="ace-icon fa fa-pencil bigger-120"></i>
																	</button>
																	<button class="btn btn-xs btn-danger"
																		onclick="doDelete(${item.tpno})">
																				...
																				<div class="label label-info label-xlg">
																					<div class="inline position-relative">
																						<a class="user-title-label" href="#"> <i
																							...
																							class="white">Template Information</span>
																						</a>
																					</div>
																				</div>
																			</div>
																		...
																		<div class="col-xs-12 col-sm-7">
																			...
																			<div
																				...
																				<div class="profile-info-row">
																					<div class="profile-info-name">템플릿 타입</div>

																					<div class="profile-info-value">
																						<i
																							class="fa fa-map-marker light-orange bigger-110"></i>
																						<span>${item.tptype}</span>
																					</div>
																				</div>

																				<div class="profile-info-row">
																					<div class="profile-info-name">템플릿 등록수</div>
																			...
																			<form>
																				<fieldset>
																					<textarea class="width-100" resize="none"
																						name="manageContent"
																						placeholder="${item.tpcomment}"></textarea>
																				</fieldset>
...
<![endif]-->
	...
	<script>
     function doEdit(templateNo){
       location.href = '../template/updatePage?templateNo='+templateNo
     }
